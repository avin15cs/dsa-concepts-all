...
public class CheckIfSubtree {
    ...
    public static boolean isSubtree(Node T, Node S) {
        //Null Tree is also a subtree
        if(S==null)
            return true;

        //T is finished, but S is still there hence return false
        if(T==null)
            return false;
        ...
        // Since, its not identical, check in left and right subtrees.
